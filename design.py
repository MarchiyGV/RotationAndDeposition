...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.R_Slider = QtWidgets.QSlider(self.widget)
        self.R_Slider.setOrientation(QtCore.Qt.Horizontal)
        self.R_Slider.setObjectName("R_Slider")
        self.gridLayout_2.addWidget(self.R_Slider, 0, 1, 1, 1)
        self.R_disp = QtWidgets.QDoubleSpinBox(self.widget)
        ...
        self.gridLayout_2.addWidget(self.R_disp, 0, 2, 1, 1)
        self.label_2 = QtWidgets.QLabel(self.widget)
        self.label_2.setObjectName("label_2")
        self.gridLayout_2.addWidget(self.label_2, 1, 0, 1, 1)
        self.k_Slider = QtWidgets.QSlider(self.widget)
        self.k_Slider.setOrientation(QtCore.Qt.Horizontal)
        self.k_Slider.setObjectName("k_Slider")
        self.gridLayout_2.addWidget(self.k_Slider, 1, 1, 1, 1)
        self.k_disp = QtWidgets.QDoubleSpinBox(self.widget)
        ...
        self.gridLayout_2.addWidget(self.k_disp, 1, 2, 1, 1)
        self.label_3 = QtWidgets.QLabel(self.widget)
        self.label_3.setObjectName("label_3")
        self.gridLayout_2.addWidget(self.label_3, 2, 0, 1, 1)
        self.NR_Slider = QtWidgets.QSlider(self.widget)
        self.NR_Slider.setOrientation(QtCore.Qt.Horizontal)
        self.NR_Slider.setObjectName("NR_Slider")
        self.gridLayout_2.addWidget(self.NR_Slider, 2, 1, 1, 1)
        self.NR_disp = QtWidgets.QDoubleSpinBox(self.widget)
