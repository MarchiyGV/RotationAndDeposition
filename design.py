...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.optimizeButton = QtWidgets.QPushButton(self.Optimization)
        self.optimizeButton.setGeometry(QtCore.QRect(160, 580, 151, 34))
        self.optimizeButton.setObjectName("optimizeButton")
        self.table_settings_opt = QtWidgets.QTableView(self.Optimization)
        self.table_settings_opt.setEnabled(True)
        self.table_settings_opt.setGeometry(QtCore.QRect(10, 30, 615, 530))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Ignored, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.optimizeButton.setText(_translate("MainWindow", "Оптимизировать"))
